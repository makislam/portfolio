...
const sampleProjects = [
  ...
  },
  {
    ...
    technologies: ['ROS2', 'Dynamixel', 'Intel RealSense', 'Computer Vision', 'Robotics', 'Python'],
  ...
  },
  {
    ...
    images: [
      '/projects/Printdnd_Video.mp4',
      '/projects/Printdnd_video2.mp4',
      '/projects/Printdnd_video3.mp4',
    ],
    technologies: ['VLA', 'PI0', 'Teleoperation', 'Robotics', 'Python'],
    live_url: 'https://printdnd.vercel.app/',
    devpost_url: 'https://devpost.com/software/printdnd?ref_content=user-portfolio&ref_feature=in_progress',
    youtube_url: 'https://www.youtube.com/watch?v=HfM9EMc2IQs&t=1s',
    featured: true,
    year: '2026',
